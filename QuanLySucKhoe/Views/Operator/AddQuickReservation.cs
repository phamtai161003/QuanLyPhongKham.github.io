...
{
    public partial class AddQuickReservation : Form
    {
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            {
                MetroMessageBox.Show(this, "Vui lòng chọn bệnh nhân và dịch vụ.", "Lỗi", MessageBoxButtons.OK,
            ...
            if (doctorId == 0)
            {
                MetroMessageBox.Show(this, "Không có bác sĩ trực cho ngày hôm nay! Liên hệ với quản trị viên!", "Lỗi",
