namespace QuanLySucKhoe.Migrations
{
    ...
    public partial class DataSeeder : DbMigration
    {
        ...
        {
            //Create pavilions
            Sql(@"INSERT INTO [dbo].[Pavilions] ([Name]) VALUES (N'Nhi Khoa')");
            Sql(@"INSERT INTO [dbo].[Pavilions] ([Name]) VALUES (N'Tai Mũi Họng')");
            Sql(@"INSERT INTO [dbo].[Pavilions] ([Name]) VALUES (N'Nha Khoa')");
            Sql(@"INSERT INTO [dbo].[Pavilions] ([Name]) VALUES (N'Mắt')");
            ...
            //Create Services
            Sql(@"INSERT INTO [dbo].[Services] ([Name], [Price], [Duration], [PavilionId]) VALUES (N'Khám Tư Vấn', 1500, 20, 1)");
            Sql(@"INSERT INTO [dbo].[Services] ([Name], [Price], [Duration], [PavilionId]) VALUES (N'Vizite Viêm Mũi', 2500, 35, 1)");
            Sql(@"INSERT INTO [dbo].[Services] ([Name], [Price], [Duration], [PavilionId]) VALUES (N'Xét Nghiệm Máu Trẻ Em', 2000, 20, 1)");

            Sql(@"INSERT INTO [dbo].[Services] ([Name], [Price], [Duration], [PavilionId]) VALUES (N'Khám Tư Vấn', 1500, 20, 2)");
            Sql(@"INSERT INTO [dbo].[Services] ([Name], [Price], [Duration], [PavilionId]) VALUES (N'Xét Nghiệm Phẫu Thuật', 2500, 30, 2)");
            Sql(@"INSERT INTO [dbo].[Services] ([Name], [Price], [Duration], [PavilionId]) VALUES (N'Echocardiography', 2000, 30, 2)");

            Sql(@"INSERT INTO [dbo].[Services] ([Name], [Price], [Duration], [PavilionId]) VALUES (N'Kiểm Tra Răng', 5000, 20, 3)");
            Sql(@"INSERT INTO [dbo].[Services] ([Name], [Price], [Duration], [PavilionId]) VALUES (N'Xét Nghiệm Xạ Trị', 1800, 15, 3)");
            Sql(@"INSERT INTO [dbo].[Services] ([Name], [Price], [Duration], [PavilionId]) VALUES (N'Lấp Đầy Nước Răng', 2500, 45, 3)");

            Sql(@"INSERT INTO [dbo].[Services] ([Name], [Price], [Duration], [PavilionId]) VALUES (N'Vizite Cho Mắt', 4300, 20, 4)");
            Sql(@"INSERT INTO [dbo].[Services] ([Name], [Price], [Duration], [PavilionId]) VALUES (N'Mổ Laser', 50000, 35, 4)");
            Sql(@"INSERT INTO [dbo].[Services] ([Name], [Price], [Duration], [PavilionId]) VALUES (N'Điều Trị Cornea', 6500, 50, 4)");
